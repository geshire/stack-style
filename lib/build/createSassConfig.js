...
var _default = function _default(config) {
  ...
  config.fx.boxShadows.forEach(function (shadow) {
    props.fx.boxShadows = "".concat(props.fx.boxShadows || "").concat(arrayItemTemplate(shadow));
  });
  /* layout
  .......................................*/
  ...
  config.forms.checkboxStyles.forEach(function (checkbox) {
    props.forms.checkboxStyles = "".concat(props.forms.checkboxStyles || "").concat(arrayItemTemplate(checkbox));
  });
  config.forms.checkboxStyles.forEach(function (checkbox) {
    props.forms.checkboxStylesByKey = "".concat(props.forms.checkboxStylesByKey || "").concat(checkbox.name, ": ").concat(arrayItemTemplate(checkbox), "\n");
  });
  config.forms.checkboxSizes.forEach(function (checkbox) {
    props.forms.checkboxSizes = "".concat(props.forms.checkboxSizes || "").concat(arrayItemTemplate(checkbox));
  });
  config.forms.checkboxSizes.forEach(function (checkbox) {
    props.forms.checkboxSizesByKey = "".concat(props.forms.checkboxSizesByKey || "").concat(checkbox.name, ": ").concat(arrayItemTemplate(checkbox), "\n");
  });
