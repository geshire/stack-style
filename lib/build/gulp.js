        ...
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            compileCSS = function compileCSS() {
              ...
              })).pipe((0, _gulpIf["default"])(!!options.flatten, (0, _gulpFlatten["default"])())).pipe((0, _gulpAutoprefixer["default"])({
                overrideBrowsersList: ['last 2 versions'],
                cascade: false
              })).pipe((0, _gulpIf["default"])(!!options.minify, (0, _gulpCleanCss["default"])({
                level: {
                  2: {
            ...
            compileCustomCSS = function compileCustomCSS() {
              ...
              _gulp["default"].src(files).pipe((0, _gulpIf["default"])(!!config.scope, _gulpInsert["default"].prepend(".".concat(config.scope, "-style {")))).pipe((0, _gulpIf["default"])(!!config.scope, _gulpInsert["default"].append('}'))).pipe((0, _gulpSass["default"])({
                ...
                overrideBrowsersList: ['last 2 versions'],
                cascade: false
              })).pipe(_gulp["default"].dest("".concat(dir, "/dist"))).pipe((0, _gulpIf["default"])(!!options.minify, (0, _gulpCleanCss["default"])())).pipe((0, _gulpConcat["default"])('styles.custom.min.css')).pipe(_gulp["default"].dest("".concat(dir, "/dist")));
            };
                  ...
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        ...
                        _gulp["default"].src("".concat(dir, "/dist/icons/*.css")).pipe((0, _gulpIf["default"])(!!options.minify, (0, _gulpCleanCss["default"])())).pipe((0, _gulpConcat["default"])('icons.min.css')).pipe(_gulp["default"].dest("".concat(dir, "/dist")));
