...
var _postcssMergeSelectors = _interopRequireDefault(require("postcss-merge-selectors"));
...
function () {
  ...
  _regenerator["default"].mark(function _callee10(curDir, config, dir, opts) {
    var options, deleteFile, deleteDir, cleanDirectories, createFolderStructure, createConfig, compileCSS, generateSvg, compileIconCSS;
        ...
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            compileCSS = function compileCSS() {
              ...
              })).pipe(_gulp["default"].dest("".concat(dir, "/dist"))).pipe((0, _gulpCleanCss["default"])()).pipe((0, _gulpConcat["default"])('styles.min.css')).pipe(_gulp["default"].dest("".concat(dir, "/dist")));
            };
