...
function () {
  ...
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee(colors, config, fileName, fileData) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            config.colors.map(function (color) {
              ...
              var hex = colors.filter(function (colorHex) {
                return colorHex.name === color.hex.replace("$", "");
              });
              params.datauri = encodeURIComponent(fileData.replace(/(fill=\"\#).{3,6}(\")/gi, "fill=\"".concat(hex[0].color, "\"")));
              icons.push({
  ...
  return function createCSS(_x, _x2, _x3, _x4) {
